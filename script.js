...
const displayMovments = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const formattedMovments = formatCur(mov, acc.locale, acc.currency);
    ...
    <div class="movements__row">
      ...
      <div class="movements__value">${formattedMovments}</div>
    </div>
    `;
...
const createUsuerName = function (accounts) {
...
// let eurToUsd = 1.1;
// let movmentsInEuro = movements.map(function (mov) {
//   return (mov *= eurToUsd);
// });
